        ...
        <TabsContent value="active-stocktake" className="pt-4">
          <div className="space-y-6">
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-xl font-medium">Active Stocktake: {activeStocktake.template}</h3>
                    ...
                    <Badge 
                      className={
                        activeStocktake.status === 'in-progress' 
                          ? "bg-kitchen-warning/10 text-kitchen-warning"
                          : "bg-kitchen-success/10 text-kitchen-success"
                      }
                    >
                      {activeStocktake.status === 'in-progress' ? 'In Progress' : 'Completed'}
                    </Badge>
                  </div>
                  
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span>Progress: {activeStocktake.itemsCounted} of {activeStocktake.itemsTotal} items</span>
                      <span className="font-medium">{activeStocktake.progress}%</span>
                    </div>
                    <Progress value={activeStocktake.progress} className="h-2" />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                    <div className="bg-kitchen-muted/30 p-3 rounded-md">
                      ...
                      <p className="text-xl font-medium">{activeStocktake.itemsCounted} items</p>
                    </div>
                    <div className="bg-kitchen-muted/30 p-3 rounded-md">
                      <p className="text-sm text-kitchen-muted-foreground">Remaining</p>
                      <p className="text-xl font-medium">{activeStocktake.itemsTotal - activeStocktake.itemsCounted} items</p>
                    </div>
                    <div className="bg-kitchen-muted/30 p-3 rounded-md">
                      <p className="text-sm text-kitchen-muted-foreground">Current Variance</p>
                      <p className={cn(
                        "text-xl font-medium",
                        activeStocktake.variance.total < 0 ? "text-kitchen-danger" : "text-kitchen-success"
                      )}>
                        {formatCurrency(activeStocktake.variance.total)}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button>Complete Stocktake</Button>
            </div>
          </div>
        </TabsContent>
